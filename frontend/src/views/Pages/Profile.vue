                                ...
                                <div class="relative flex justify-between w-full">
                                    ...
                                    <div class="flex flex-1">
                                        ...
                                        <div class="mx-2">
                                            ...
                                            <p class="text-sm leading-5 font-medium text-gray-500">{{ user.email }}</p>
                                        </div>
                                    </div>
                                    <div class="flex flex-col-reverse">
                                        ...
                                        <div
                                            ...
                                            <div class="text-center px-3"><span
                                                    class="font-bold text-blue-4">10</span><span class="text-gray-600">
                                                    Publication</span></div>
                                            <div class="text-center px-3"><span class="font-bold text-blue-4">20
                                                </span><span class="text-gray-600">Commande</span></div>
...
import Etudiant from '../Admin/Reservation/Etudiant.vue';
export default {
    name: 'Profile',
    components: {
