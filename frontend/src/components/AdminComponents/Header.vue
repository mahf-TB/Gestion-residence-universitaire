            ...
            <div class="container flex items-center justify-between h-[65px]">
                <div class="text-blue-0 h-full ">
                    <nav class="h-full text-[14px] flex items-center">
                        ...
                        <Button @click="$refs.menu2.toggle($event)" :class="{ 'border-b-4 border-blue-0': $route.path === '/admin/liste-commande' || $route.path === '/admin/restaurent' || $route.path === '/admin/service' }"
